            ...
            <Col lg={4}>
                <p>
                    <p style={{textAlign: "center", padding: "7px", borderRadius: "10px"}}>
                        <strong style={{margin:"2px", textAlign: "center", borderRadius: "10px", background:'#fe7f7f none repeat scroll 0% 0%', minWidth:"45px", display:"inline-table"}}>{this.props.update[0]}</strong>
                        <strong style={{margin:"2px", textAlign: "center", borderRadius: "10px", background:'rgb(254, 254, 127) none repeat scroll 0% 0%', minWidth:"45px", display:"inline-table"}}>{this.props.update[1]}</strong>
                        ...
                        <strong style={{margin:"2px", textAlign: "center", borderRadius: "10px", background:'rgb(254, 254, 127) none repeat scroll 0% 0%', minWidth:"45px", display:"inline-table"}}>{this.props.update[2]}</strong>
                        <strong style={{margin:"2px", textAlign: "center", borderRadius: "10px", background:'#fe7f7f none repeat scroll 0% 0%', minWidth:"45px", display:"inline-table"}}>{this.props.update[3]}</strong></p>
                </p>
            </Col>
            <Col lg={4}>
